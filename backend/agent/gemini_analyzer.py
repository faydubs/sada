...
9) العملة الافتراضية SAR ما لم يُذكر غيرها.
10) املأ transcript بتفريغ نصي أمين للمقطع (بالعربية)، وnotes بأي سياق مفيد.
11) confidence رقم بين 0.0 و1.0 يعكس مدى وضوح المقطع وثقتك بالاستخراج.
"""
